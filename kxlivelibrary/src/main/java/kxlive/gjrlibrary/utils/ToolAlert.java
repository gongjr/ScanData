...
import kxlive.gjrlibrary.widget.NotificationMessage;
import kxlive.gjrlibrary.widget.ProgressDialog;
...
public class ToolAlert {
    ...
    public static void toastShort(String msg) {
        Toast.makeText(BaseApplication.gainContext(), msg, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void toast(String msg,int duration) {
        Toast.makeText(BaseApplication.gainContext(), msg, duration).show();
    }
